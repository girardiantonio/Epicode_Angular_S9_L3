"use strict";
const choseLabel = document.getElementById("inputGroupSelect01");
const redLordo = document.getElementById("inputfield");
const redNumber = document.getElementById("rednum");
const inpsNumber = document.getElementById("inpsnum");
const irpefNumber = document.getElementById("irpefnum");
const formReference = document.getElementById("form");
const resultReference = document.getElementById("result");
class Lavoratore {
    constructor(codRedd, tasseInps, tasseIrpef) {
